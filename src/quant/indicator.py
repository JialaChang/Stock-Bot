...
def compute_indicators(ticker: str, history_data: pd.DataFrame) -> None:
    """
    量化回測用途：將全套技術指標原地寫入傳入的資料
    """
    ...
    # EMA5 短線、EMA10 中線、EMA20 月線、EMA60 季線
    ...
    history_data['EMA_60'] = pta.ema(close, length=60) # pyright: ignore[reportPrivateImportUsage]
